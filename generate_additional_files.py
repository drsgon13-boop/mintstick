...
Icon-Name=xsi-media-removable-symbolic
Selection=S
Extensions=iso;img;
"""
...
Icon-Name=xsi-edit-clear-all-symbolic
Selection=S
Extensions=any;
...
<policyconfig>
  ...
  <action id="com.linuxmint.mintstick-write">
...
suffix="""
    ...
    <annotate key="org.freedesktop.policykit.exec.path">/usr/bin/mint-stick-write</annotate>
...
additionalfiles.generate_polkit_policy(DOMAIN, PATH, "share/polkit/com.linuxmint.mintstick-write.policy", prefix, _("This will destroy all data on the USB stick, are you sure you want to proceed?"), suffix)
...
<policyconfig>
  ...
  <action id="com.linuxmint.mintstick-format">
    <description>USB Image Writer / USB Stick Formatter</description>
"""
...
suffix="""
    ...
    <annotate key="org.freedesktop.policykit.exec.path">/usr/bin/mint-stick-format</annotate>
    <annotate key="org.freedesktop.policykit.exec.allow_gui">true</annotate>
  </action>
...
additionalfiles.generate_polkit_policy(DOMAIN, PATH, "share/polkit/com.linuxmint.mintstick-format.policy", prefix, _("This will destroy all data on the USB stick, are you sure you want to proceed?"), suffix)
